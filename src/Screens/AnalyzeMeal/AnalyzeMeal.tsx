...
class AnalyzeMeal extends Component {
  ...
  render() {
    let pieData = [
      { key: "pie0", svg: { fill: "#ffcc80" }, value: 50 },
      { key: "pie1", svg: { fill: "#ef9a9a" }, value: 10 },
      { key: "pie2", svg: { fill: "#c5e1a5" }, value: 20 },
    ];
    return (
      <>
            ...
            <View>
              ...
              <View style={{ flexDirection: "row", marginLeft: 20 }}>
                ...
                >
                  ...
                  <Text style={{ fontSize: 10, color: "#4caf50", textAlign: "center" }}>
                    Protein
                  </Text>
                </View>
                <View
                ...
                >
                  <Text style={{ fontSize: 20, color: "#b71c1c", textAlign: "center" }}>
                    {data.totalNutrientsKCal["FAT_KCAL"].quantity}
                  </Text>
                  <Text style={{ fontSize: 10, color: "#b71c1c", textAlign: "center" }}>
                    Fat
                  </Text>
                </View>
                <View
                ...
                >
                  <Text style={{ fontSize: 20, color: "#bf360c", textAlign: "center" }}>
                    {data.totalNutrientsKCal["CHOCDF_KCAL"].quantity}
                  </Text>
                  <Text style={{ fontSize: 10, color: "#bf360c", textAlign: "center" }}>
                    Carbs
                  </Text>
                </View>
              </View>
